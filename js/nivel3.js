...
NUESTRO_TITULO.textContent = "Hola mundo!";
/*
    Editando atributos
    ==================
...
NUESTRO_TITULO.style.backgroundColor = "orange";
// NUESTRO_TITULO.style.fontSize = "50rem";
/*
...
NUEVA_IMAGEN.src = "img/woman_bw.jpg";

document.querySelector("header").appendChild(NUEVA_IMAGEN);

// const NUEVO_TITULO = document.createElement("h2");
// NUEVO_TITULO.textContent = "Practica agregar nuevos elementos, NUEVO_TITULO";
// document.querySelector("header").appendChild(NUEVO_TITULO);
